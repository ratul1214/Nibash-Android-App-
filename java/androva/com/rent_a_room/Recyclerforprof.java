...
public class Recyclerforprof extends RecyclerView.Adapter<Recyclerforprof.ViewHolder> {
        Context context;
...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public TextView location,price,toiletnum,roomnum,catagory;
    ...
    public Recyclerforprof(List<Adddetail> myDataset) {
        mDataset = myDataset;
    }
    @Override
    public Recyclerforprof.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                               int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.rentlist, parent, false);

        Recyclerforprof.ViewHolder vh = new Recyclerforprof.ViewHolder(v);
        return vh;
    }
    @Override
    public void onBindViewHolder(Recyclerforprof.ViewHolder holder, int position) {
